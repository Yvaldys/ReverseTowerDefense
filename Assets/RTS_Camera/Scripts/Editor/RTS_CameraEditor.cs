    ...
    public class RTS_CameraEditor : Editor
    {
        ...
        private void RotationTab()
        {
            ...
            if(camera.useKeyboardRotation)
            {
                ...
                camera.fixedRotation = EditorGUILayout.Toggle("Fixed rotation : ", camera.fixedRotation);
                if (camera.fixedRotation) {
                    camera.fixedAngle = EditorGUILayout.FloatField("Fixed rotation angle", camera.fixedAngle);
                    camera.fixedTranslation = EditorGUILayout.FloatField("Fixed position translation", camera.fixedTranslation);
                } else {
